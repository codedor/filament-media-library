<div>
    ...
    {{--                                <input wire:model="attachments" multiple id="file-upload" name="file-upload" type="file" class="sr-only">--}}
    {{--                            </label>--}}
